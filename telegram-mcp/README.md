...
### Codex Configuration (Windows)

For Codex, create or update `C:\Users\Tung\.codex\config.toml`:
...
args = [
  "--directory",
  "D:\\CyPeace\\Threat Intel\\telegram-mcp",
  "run",
  "main.py"
]
```

After saving, restart Codex so the MCP server is reloaded.
